...
// Retrieve an offer
Client.prototype.getOffer = function(pId, oId) {
    return this.request("GET", "products/"+pId+"/offer_codes/"+oId).get("offer_code");
};
...
// List sales
Client.prototype.listSales = function(after, before, page) {
...
// Retrieve a sale
Client.prototype.listSales = function(sId) {
    return this.request("GET", "sales/"+sId).get("sale");
};
